export default function Skills() {
  return (
    <div className="flex flex-col gap-4 max-w-7xl mx-auto p-8 w-full mb-10 md:mb-20">
        ...
        <div className="flex flex-col gap-4">
          ...
          <div className="flex flex-col gap-2">
            <div className="flex flex-row gap-2 items-center">
              ...
              <p className="text-md text-primary-foreground">Figma</p>
            </div>
            <div className="flex flex-row gap-2 items-center">
              <svg
                xmlns="http://www.w3.org/2000/svg"
              ...
              <p className="text-md text-white">Tailwind CSS</p>
            </div>
          </div>
        </div>
        <div className="flex flex-col gap-4">
          ...
          <div className="flex flex-col gap-2">
            <div className="flex flex-row gap-2 items-center">
              ...
              <p className="text-md text-primary-foreground">HTML/CSS</p>
            </div>
            <div className="flex flex-row gap-2 items-center">
              <svg
                xmlns="http://www.w3.org/2000/svg"
              ...
              <p className="text-md text-primary-foreground">Typescript</p>
            </div>
            <div className="flex flex-row gap-2 items-center">
              <svg
                xmlns="http://www.w3.org/2000/svg"
        ...
        <div className="flex flex-col gap-4">
          ...
          <div className="flex flex-col gap-2">
            <div className="flex flex-row gap-2 items-center">
              ...
              <p className="text-md text-primary-foreground">PostgresSQL</p>
            </div>
            <div className="flex flex-row gap-2 items-center">
              <svg
                xmlns="http://www.w3.org/2000/svg"
              ...
              <p className="text-md text-white">Node.js</p>
            </div>
            <div className="flex flex-row gap-2 items-center">
              <svg
                xmlns="http://www.w3.org/2000/svg"
        ...
        <div className="flex flex-col gap-4">
          ...
          <div className="flex flex-col gap-2">
            <div className="flex flex-row gap-2 items-center">
              ...
              <p className="text-md text-primary-foreground">Git & Github</p>
            </div>
            <div className="flex flex-row gap-2 items-center">
              <svg
                xmlns="http://www.w3.org/2000/svg"
              ...
              <p className="text-md text-white">Docker</p>
            </div>
            <div className="flex flex-row gap-2 items-center">
              <svg
                viewBox="0 0 128 128"
              ...
              <p className="text-md text-white">AWS / Vercel</p>
            </div>
          </div>
        </div>
      </div>
